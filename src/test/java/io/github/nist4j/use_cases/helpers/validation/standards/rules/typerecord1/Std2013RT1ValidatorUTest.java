...
import static io.github.nist4j.enums.records.RT1FieldsEnum.GNS;
...
import static io.github.nist4j.enums.validation.StdNistValidatorErrorEnum.STD_ERR_ANM_OAN_RT1;
...
import static io.github.nist4j.enums.validation.StdNistValidatorErrorEnum.STD_ERR_GNS_RT1;
...
class Std2013RT1ValidatorUTest {

  private final Std2013RT1Validator validator = new Std2013RT1Validator();
  ...
  void setUp() {
    NistRecordBuilder nistRecordBuilder1 =
        record1Cas1_basic_Record_withVersion(ANSI_NIST_ITL_2013.getCode());
  ...
  void validate_should_return_empty_list_with_record4_and_valid_fields_in_record1()
    ...
    NistRecordBuilder nistRecordBuilder =
        record1Cas3_full_Record()
            .withField(VER, newFieldText(ANSI_NIST_ITL_2013.getCode()))
