...
public class Std2007RT3ValidatorUTest {
  private static final NistOptions NIST_OPTIONS = DEFAULT_OPTIONS_FOR_VALIDATION;
  private final Std2007RT3Validator validator = new Std2007RT3Validator(NIST_OPTIONS);
  ...
  void validate_should_return_list_with_errors_with_missing_mandatory_field_in_record() {
    ...
    // When
    List<NistValidationError> errorsNist = mapper.fromValidationResult(validator.validate(rt3));
  ...
  void validate_should_validate_ok_rt3() {
    ...
    NistRecord rt3 =
        new RT3LowResolutionGrayscaleFingerprintNistRecordBuilderImpl(NIST_OPTIONS)
            .withField(RT3FieldsEnum.LEN, newFieldText(123))
            .withField(RT3FieldsEnum.IDC, newFieldText(1))
            .withField(RT3FieldsEnum.IMP, newFieldText(1))
            .withField(
                RT3FieldsEnum.FGP,
