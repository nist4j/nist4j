...
class RT3LowResolutionGrayscaleFingerprintNistRecordBuilderImplUTest {
  ...
  void build_should_calculate_the_length_including_him_self() {
    ...
    NistRecord nistRecord =
        new RT3LowResolutionGrayscaleFingerprintNistRecordBuilderImpl(OPTIONS_CALCULATE_ON_BUILD)
