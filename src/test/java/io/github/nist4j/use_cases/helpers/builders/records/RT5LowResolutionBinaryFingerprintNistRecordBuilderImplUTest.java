...
class RT5LowResolutionBinaryFingerprintNistRecordBuilderImplUTest {
  @Test
  void build_should_calculate_the_length_including_him_self() {
    // Given
    // When
    NistRecord nistRecord =
        new RT5LowResolutionBinaryFingerprintNistRecordBuilderImpl(OPTIONS_CALCULATE_ON_BUILD)
