...
public class Std2015RT5ValidatorUTest {
  private static final NistOptions NIST_OPTIONS = DEFAULT_OPTIONS_FOR_VALIDATION;
  private final Std2015RT5Validator validator = new Std2015RT5Validator(NIST_OPTIONS);
  ...
  void validate_should_return_list_with_errors_with_missing_mandatory_field_in_record() {
    ...
    // When
    List<NistValidationError> errorsNist = validator.validate(rt5).getErrors();
