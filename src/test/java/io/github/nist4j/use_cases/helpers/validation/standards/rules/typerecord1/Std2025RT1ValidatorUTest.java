...
class Std2025RT1ValidatorUTest {

  private final Std2025RT1Validator validator = new Std2025RT1Validator();
  ...
  void setUp() {
    NistRecordBuilder nistRecordBuilder1 =
        record1Cas1_basic_Record_withVersion(ANSI_NIST_ITL_2025.getCode());
  ...
  void validate_should_return_empty_list_with_record4_and_valid_fields_in_record1()
    ...
    NistRecordBuilder nistRecordBuilder =
        record1Cas3_full_Record()
            .withField(VER, newFieldText(ANSI_NIST_ITL_2025.getCode()))
