...
public class ValidationResultTest {
  ...
  public void testIsInvalidThrow() {
    assertThatThrownBy(
            () ->
                ValidationResult.fail(new ArrayList<>())
                    .isInvalidThrow(Nist4jValidationSampleException.class))
        .isInstanceOf(Nist4jValidationSampleException.class);
    assertThatCode(
            () -> ValidationResult.ok().isInvalidThrow(Nist4jValidationSampleException.class))
