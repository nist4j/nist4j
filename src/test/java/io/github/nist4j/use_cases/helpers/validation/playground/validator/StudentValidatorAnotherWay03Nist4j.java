...
// @formatter:off
public class StudentValidatorAnotherWay03Nist4j extends AbstractValidator<Student> {
  ...
  public void rules() {
    ...
    ruleFor(root -> root)
        .must(
            not(stringEmptyOrNull(Student::getId))
                .and(not(stringEmptyOrNull(Student::getEnrolmentId))))
