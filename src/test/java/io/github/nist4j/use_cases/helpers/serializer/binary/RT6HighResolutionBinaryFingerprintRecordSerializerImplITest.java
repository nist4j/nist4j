...
class RT6HighResolutionBinaryFingerprintRecordSerializerImplITest {
  ...
  void read_should_be_able_to_read_a_reference_nistFile() throws Exception {
    ...
    assertThat(resultRecord.getFieldText(GenericBinaryFieldsEnum.LEN)).hasValue("75970");
    ...
    assertThat(resultRecord.getFieldText(GenericBinaryFieldsEnum.HLL)).hasValue("804");
    assertThat(resultRecord.getFieldText(GenericBinaryFieldsEnum.VLL)).hasValue("752");
