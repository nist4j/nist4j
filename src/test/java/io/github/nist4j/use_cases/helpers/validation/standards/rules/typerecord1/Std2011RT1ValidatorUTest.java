...
class Std2011RT1ValidatorUTest {
  ...
  void setUp() {
    NistRecordBuilder nistRecordBuilder1 =
        record1Cas1_basic_Record_withVersion(ANSI_NIST_ITL_2011.getCode());
  ...
  void validate_should_return_empty_list_with_record4_and_valid_fields_in_RT1() throws IOException {
    ...
    NistRecordBuilder nistRecordBuilder =
        record1Cas3_full_Record()
            .withField(VER, newFieldText(ANSI_NIST_ITL_2011.getCode()))
  ...
  void validate_should_return_multiple_items_with_record4_and_invalid_fields_in_record1()
    ...
    nistRecordBuilder.withField(VER, newFieldText(ANSI_NIST_ITL_2011.getCode())); // Valid
    nistRecordBuilder.withField(
