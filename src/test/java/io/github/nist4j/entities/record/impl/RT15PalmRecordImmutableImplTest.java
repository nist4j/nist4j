...
class RT15PalmRecordImmutableImplTest {

  @Test
  void getIFieldTypeEnumValues() {
    // Given
    NistRecordBuilder builder =
        new RT15PalmNistRecordBuilderImpl(OptionsFixtures.OPTIONS_DONT_CHANGE_ON_BUILD);
    // When
    NistRecord nistRecord = new RT15PalmRecordImmutableImpl(builder);

    // Then
    assertThat(nistRecord).isNotNull();
    assertThat(nistRecord.getIFieldTypeEnumValues().size()).isEqualTo(37);
  }
}
