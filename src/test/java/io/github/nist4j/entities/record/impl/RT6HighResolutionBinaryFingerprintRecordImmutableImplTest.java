...
class RT6HighResolutionBinaryFingerprintRecordImmutableImplTest {

  @Test
  void getIFieldTypeEnumValues() {
    // Given
    NistRecordBuilder builder =
        new RT6HighResolutionBinaryFingerprintNistRecordBuilderImpl(
            OptionsFixtures.OPTIONS_DONT_CHANGE_ON_BUILD);
    // When
    NistRecord nistRecord = new RT6HighResolutionBinaryFingerprintRecordImmutableImpl(builder);
