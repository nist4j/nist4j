...
class RT7UserDefinedImageRecordImmutableImplTest {

  @Test
  void getIFieldTypeEnumValues() {
    // Given
    NistRecordBuilder builder =
        new RT7UserDefinedImageNistRecordBuilderImpl(OptionsFixtures.OPTIONS_DONT_CHANGE_ON_BUILD);
    // When
    NistRecord nistRecord = new RT7UserDefinedImageRecordImmutableImpl(builder);
