...
class RT4HighResolutionGrayscaleFingerprintRecordImmutableRecordImplTest {

  @Test
  void getIFieldTypeEnumValues() {
    // Given
    NistRecordBuilder builder =
        new RT4HighResolutionGreyscaleFingerprintNistRecordBuilderImpl(
            OptionsFixtures.OPTIONS_DONT_CHANGE_ON_BUILD);
    // When
    NistRecord nistRecord =
        new RT4HighResolutionGrayscaleFingerprintRecordImmutableRecordImpl(builder);
