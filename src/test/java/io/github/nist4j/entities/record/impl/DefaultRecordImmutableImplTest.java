...
class DefaultRecordImmutableImplTest {

  @Test
  void getIFieldTypeEnumValues() {
    // Given
    NistRecordBuilder builder =
        new DefaultNistTextRecordBuilderImpl(OptionsFixtures.OPTIONS_DONT_CHANGE_ON_BUILD, 18);
    // When
    NistRecord nistRecord = new DefaultRecordImmutableImpl(18, builder);

    // Then
    assertThat(nistRecord).isNotNull();
    assertThat(nistRecord.getIFieldTypeEnumValues().size()).isEqualTo(26);
  }
}
