...
import static io.github.nist4j.enums.RecordTypeEnum.RT9;
...
@Slf4j
public final class RT9MinutiaeDataNistRecordBuilderImpl extends AbstractNistRecordBuilderImpl
    implements NistRecordBuilder {

  public RT9MinutiaeDataNistRecordBuilderImpl(NistOptions nistOptions) {
    super(
        nistOptions,
        RT9.getNumber(),
        RT9.getLabel(),
