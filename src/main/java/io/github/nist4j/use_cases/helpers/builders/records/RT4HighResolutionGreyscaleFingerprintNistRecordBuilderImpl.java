...
@Slf4j
public final class RT4HighResolutionGreyscaleFingerprintNistRecordBuilderImpl
    extends AbstractNistRecordBuilderImpl implements NistRecordBuilder {

  public RT4HighResolutionGreyscaleFingerprintNistRecordBuilderImpl(NistOptions nistOptions) {
    super(
        nistOptions,
        RT4.getNumber(),
        RT4.getLabel(),
