...
@Slf4j
public class RT10FacialSMTImageRecordSerializerImpl
    extends AbstractTextRecordSerializer<RT10FacialSMTImageNistRecordBuilderImpl>
    implements RecordReader, RecordWriter {

  public RT10FacialSMTImageRecordSerializerImpl(NistOptions nistOptions) {
    super(nistOptions, new RT10FacialSMTImageNistRecordBuilderImpl(nistOptions));
  }
}
