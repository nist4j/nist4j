...
import io.github.nist4j.use_cases.helpers.validation.standards.rules.typerecord1.Std2011RT1Validator;
import io.github.nist4j.use_cases.helpers.validation.standards.rules.typerecord10.Std2011RT10Validator;
...
/**
 * Specification for Standard 2011
 */
@Getter
public class Std2011Validator extends AbstractStdValidator {
  ...
  public Std2011Validator() {
    this(DEFAULT_OPTIONS_FOR_VALIDATION);
  }

  public Std2011Validator(NistOptions nistOptions) {
    super(nistOptions);
