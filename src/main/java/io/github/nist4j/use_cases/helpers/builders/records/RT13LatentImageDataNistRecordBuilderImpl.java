...
@Slf4j
public final class RT13LatentImageDataNistRecordBuilderImpl extends AbstractNistRecordBuilderImpl
    implements NistRecordBuilder {

  public RT13LatentImageDataNistRecordBuilderImpl(NistOptions nistOptions) {
    super(
        nistOptions,
        RT13.getNumber(),
        RT13.getLabel(),
