...
public interface WheneverProperty<T, P>
    extends Whenever<T, P, WhenProperty<T, P>, WheneverProperty<T, P>> {

  WithValidator<T, P, WhenProperty<T, P>, WheneverProperty<T, P>> withValidator(
