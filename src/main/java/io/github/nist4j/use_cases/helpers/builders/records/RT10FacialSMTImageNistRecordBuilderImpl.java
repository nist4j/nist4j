...
@Slf4j
public final class RT10FacialSMTImageNistRecordBuilderImpl extends AbstractNistRecordBuilderImpl
    implements NistRecordBuilder {

  public RT10FacialSMTImageNistRecordBuilderImpl(NistOptions nistOptions) {
    super(
        nistOptions,
        RT10.getNumber(),
        RT10.getLabel(),
