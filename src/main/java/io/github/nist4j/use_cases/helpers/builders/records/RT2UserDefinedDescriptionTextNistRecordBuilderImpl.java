...
@Slf4j
public final class RT2UserDefinedDescriptionTextNistRecordBuilderImpl
    extends AbstractNistRecordBuilderImpl implements NistRecordBuilder {

  public RT2UserDefinedDescriptionTextNistRecordBuilderImpl(NistOptions nistOptions) {
    super(
        nistOptions,
        RT2.getNumber(),
        RT2.getLabel(),
