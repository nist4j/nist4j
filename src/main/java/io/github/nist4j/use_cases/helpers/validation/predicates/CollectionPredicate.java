...
public final class CollectionPredicate {
  ...
  public static <E, T extends Collection<E>> Predicate<T> hasAny(final Collection<E> objects) {
    return PredicateBuilder.<T>from(notNullValue())
        .and(obj -> notNullValue().test(objects))
  ...
  public static <T, E> Predicate<T> hasAny(
      final Function<T, Collection<E>> source, final Collection<E> objects) {
    return PredicateBuilder.<T>from(notNullValue())
        .and(obj -> hasAny(objects).test(source.apply(obj)));
  }

  public static <T, E> Predicate<T> hasAny(
      final Function<T, Collection<E>> source, final E[] objects) {
    return PredicateBuilder.<T>from(notNullValue())
        .and(obj -> hasAny(objects).test(source.apply(obj)));
  }
  ...
  public static <E, T extends Collection<E>> Predicate<T> hasItem(final E object) {
    return PredicateBuilder.<T>from(notNullValue()).and(obj -> obj.contains(object));
  }

  public static <T, E> Predicate<T> hasItem(
      final Function<T, Collection<E>> source, final E object) {
    return PredicateBuilder.<T>from(notNullValue())
  ...
  public static <T, E> Predicate<T> hasItems(
      final Function<T, Collection<E>> source, final Collection<E> objects) {
    return PredicateBuilder.<T>from(notNullValue())
  ...
  public static <T, E> Predicate<T> hasSize(
      final Function<T, Collection<E>> source, final Function<T, Integer> size) {
    return PredicateBuilder.<T>from(notNullValue())
        .and(obj -> notNullValue(size).test(obj))
        .and(obj -> notNullValue(source).test(obj))
        .and(obj -> equalTo(size.apply(obj)).test(source.apply(obj).size()));
  }

  public static <T, E> Predicate<T> hasSize(
      final Function<T, Collection<E>> source, final Integer size) {
    return PredicateBuilder.<T>from(notNullValue())
        .and(obj -> notNullValue(source).test(obj))
  ...
  public static <E, T extends Collection<E>> Predicate<T> hasSize(final Integer size) {
    return PredicateBuilder.<T>from(notNullValue()).and(obj -> equalTo(size).test(obj.size()));
  }

  public static <T, E> Predicate<T> hasSizeBetween(
      final Function<T, Collection<E>> source, final Integer min, final Integer max) {
    return PredicateBuilder.<T>from(notNullValue())
        .and(obj -> notNullValue(source).test(obj))
        .and(obj -> between(min, max).test(source.apply(obj).size()));
  }

  public static <E, T extends Collection<E>> Predicate<T> hasSizeBetween(
      final Integer min, final Integer max) {
    return PredicateBuilder.<T>from(notNullValue()).and(between(Collection::size, min, max));
  }

  public static <T, E> Predicate<T> hasSizeBetweenInclusive(
      final Function<T, Collection<E>> source, final Integer min, final Integer max) {
    return PredicateBuilder.<T>from(notNullValue())
        .and(obj -> notNullValue(source).test(obj))
  ...
  public static <E, T extends Collection<E>> Predicate<T> hasSizeBetweenInclusive(
      final Integer min, final Integer max) {
    return PredicateBuilder.<T>from(notNullValue())
