...
@Slf4j
public final class RT14VariableResolutionFingerprintRecordImmutableImpl
    extends AbstractRecordImmutable implements NistRecord {

  private static final RecordTypeEnum recordTypeEnum = RecordTypeEnum.RT14;

  public RT14VariableResolutionFingerprintRecordImmutableImpl(NistRecordBuilder nistRecordBuilder) {
  ...
  public Set<IFieldTypeEnum> getIFieldTypeEnumValues() {
    return new HashSet<>(Arrays.asList(RT14FieldsEnum.values()));
  }
}
