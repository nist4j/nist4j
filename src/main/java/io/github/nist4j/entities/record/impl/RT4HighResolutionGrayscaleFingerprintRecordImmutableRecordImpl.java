...
@Slf4j
public final class RT4HighResolutionGrayscaleFingerprintRecordImmutableRecordImpl
    extends AbstractRecordImmutable implements NistRecord {

  private static final RecordTypeEnum recordTypeEnum = RecordTypeEnum.RT4;

  public RT4HighResolutionGrayscaleFingerprintRecordImmutableRecordImpl(
  ...
  public Set<IFieldTypeEnum> getIFieldTypeEnumValues() {
    return new HashSet<>(Arrays.asList(RT4FieldsEnum.values()));
  }
}
