...
public final class RT1TransactionInformationRecordImmutableImpl extends AbstractRecordImmutable
    implements NistRecord {

  private static final RecordTypeEnum recordTypeEnum = RecordTypeEnum.RT1;

  public RT1TransactionInformationRecordImmutableImpl(NistRecordBuilder nistRecordBuilder) {
  ...
  public Set<IFieldTypeEnum> getIFieldTypeEnumValues() {
    return new HashSet<>(Arrays.asList(RT1FieldsEnum.values()));
  }
}
