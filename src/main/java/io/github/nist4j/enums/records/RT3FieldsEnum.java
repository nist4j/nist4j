...
@AllArgsConstructor
@Getter
public enum RT3FieldsEnum implements IFieldTypeEnum {
  ...
  private final RecordTypeEnum recordType = RecordTypeEnum.RT3;
  ...
  <T extends IFieldTypeEnum> RT3FieldsEnum(T parentEnum) {
    this(
        parentEnum.getId(),
        parentEnum.getCode(),
