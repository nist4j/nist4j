...
@Getter
public enum NistRefSubjectBodyStatusCodeEnum implements INistReferentielEnum {
  WHOLE_BODY("1", "Whole body", ANSI_NIST_ITL_2013, null),
  BODY_FRAGMENT("2", "Body fragment", ANSI_NIST_ITL_2013, null),
  ;
